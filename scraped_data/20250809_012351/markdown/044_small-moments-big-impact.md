...
Source: https://corporate.onekeymls.com/small-moments-big-impact
...
April is the National Association of REALTORS® (NAR)[Fair Housing month](https://www.nar.realtor/fair-housing/fair-housing-month) and a great time to reinforce how good habits and actions, big and small, keep us accountable and have a significant impact in championing fair and equitable access to housing for all. Assuring that everyone has the same access to information about listings and opportunities to view properties is essential. Take action and supportFair Housing Forwardby:

An Overview of the Fair Housing Act - YouTube

[Photo image of National Association of REALTORS](https://www.youtube.com/channel/UCHkeJOyp0Pb3dJSt4iXjPQA?embeds_referring_euri=https%3A%2F%2Fcorporate.onekeymls.com%2F)

National Association of REALTORS

29.4K subscribers

[An Overview of the Fair Housing Act](https://www.youtube.com/watch?v=94TVHAJtang)
...
![](https://lirp.cdn-website.com/78412f62/dms3rep/multi/opt/pexels-photo-6249432-1920w.jpeg)
...
- **Using inclusive language in your listing remarks and ensure that you describe the property, not neighborhoods or people.** Consider how your language aligns with Fair Housing guidelines and that you accurately and inclusively represent the property. Remember that the[law](https://www.nyc.gov/site/fairhousing/rights-responsibilities/real-estate-advertisements.page#:~:text=The%20law%20prohibits%20the%20making,to%20features%20of%20the%20property)prohibits directly or indirectly stating a preference or limitation based on any protected classes.
...
- **Boosting transparency about layout by including floorplans**with your listings. Your OneKey MLS subscription includes floor plans through[CubiCasa](https://corporate.onekeymls.com/products/cubicasa), an easy and accessible way to add information to your listing.

- **Highlighting down payment assistance programs**and affordability options to make home ownership as accessible as possible with[Down Payment Resource](https://corporate.onekeymls.com/), included with your OneKey MLS subscription.

Test Your Knowledge Answer Key:

1. False, Coming Soon listings are not available for showings.
2. True
3. False, though signs are considered a form of advertising and would indicate a listing that must be entered within 1 (one) business day, they may remain in place after a listing goes under contract.
4. True
5. It depends . . . if an offer is accepted with no more showings it should be updated to Temp Off Market. If there is an accepted offer, but the seller has instructed you to continue showing the property it may stay Active.
6. False, a contract must be fully executed by both parties to be Pending status.
7. True
