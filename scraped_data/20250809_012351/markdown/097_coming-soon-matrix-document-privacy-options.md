...
Source: https://corporate.onekeymls.com/coming-soon-matrix-document-privacy-options
...
- **Private**
\- The document will be visible only to the listing agent (and assistants/office managers and brokers within the office with access to the listing) and does not aggregate to the other sites.
- **Public**
\- The document is visible to other Matrix users inside the MLS and aggregates to OneHome and other broker feeds. Note: Public means broker to broker, not consumers. IDX and VOW feeds do not receive documents.
...
or **Private**
for each type. All supplement types are public except: _Other  (Private)_ and _Seller Exclusive Seller Disclosure (Private)_. Learn more about [adding](https://support.onekeymls.com/hc/en-us/articles/32852833217684-Adding-and-Editing-Matrix-Documents-with-Listing-Manager)
and [viewing documents in Matrix](https://support.onekeymls.com/hc/en-us/articles/35551477190036-How-to-View-Matrix-Documents-on-Listings).

All listings that currently include documents will have the Supplement Type defaulted to _Other (Private)_ **to prevent public exposure of items.**

**The following feeds will receive documents:**

1. **PT (Broker Only) feed will include all office documents (public and private).**
2. **BO (Back Office) feed will include all public documents.**

### Split Level Added to Search Criteria

![](https://lirp.cdn-website.com/78412f62/dms3rep/multi/opt/split+level-1920w.jpg)

**Split Level**has been added as an option under theArchitectural Stylefield.
