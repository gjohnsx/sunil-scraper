# 
    ...
    SentriLock® | OneKey® MLS
  
  

Source: https://corporate.onekeymls.com/products/sentrilock
...
![SentriLock](https://lirp.cdn-website.com/78412f62/dms3rep/multi/opt/SentriLock_Logo-1920w.png)

### Designed for REALTORS® who need reliable access to homes whether or not they have cell service, SentriLock®’s lockboxes are smart, secure, easy to use and enable you to access homes using Bluetooth or Near Field Technology (NFT). The SentriKey® App allows easy access and tracking.

**PREMIUM PRODUCT**

[TO ACTIVATE YOUR SENTRILOCK® SUBSCRIPTION PLEASE](https://corporate.onekeymls.com/) [**CLICK HERE**](https://lockbox.onekeymls.com/) [AND ENTER YOUR USERNAME AND PASSWORD.](https://corporate.onekeymls.com/)

* * *

[SentriLock® Support](https://support.onekeymls.com/hc/en-us/articles/27445062574740-SentriLock-Resources)

## Premium: Easy and secure entry, whether you’re there or not.

#### Flexible and mobile

SentriKey® real estate app and software system helps manage lockbox access, showings, and client experiences.

#### Reliable without cellular service

SentriLock’s mission is simple: 100% access, 100% of the time. That means giving REALTORS® the gold standard: A lockbox that works with cell service, or even more important, without it. SentriLock’s lockboxes can be opened via Bluetooth™ or Near Field Technology (NFT), or with a code on a keypad. This is especially important for properties in remote or rural areas with poor cellular coverage.

#### Durable, long-lasting, and secure

Made with hardened steel, SentriLock’s SentriGuard® lockboxes are resistant to corrosion, prying, drills, and even bolt cutters. The primary battery is replaceable and lasts 10 years to maximize functionality and minimize maintenance. The built-in backup battery guards against complete power failure. There is even an extra large key bin for the assortment of keys that come with today’s properties.

#### Safety first

Every SentriLock® lockbox is designed to notify agents and clients when it’s opened and closed, signifying when a property is entered and exited. Through the SentriKey® app, alerts can also be sent to emergency contacts when an agent’s safety is threatened.

### SentriLock® Applications and Lock Box

[Button](https://corporate.onekeymls.com/products/sentrilock)

### SentriConnect from SentriLock®

[Button](https://corporate.onekeymls.com/products/sentrilock)

### SentriLock® Lockbox Inventory
...
- Manage and operate lockbox from phone
- Generate access codes
- Schedule access to prevent crossover appointments


##### Convenient and easy

- Unlocks with Bluetooth® or NFT
- Integrates with ShowingTime™, Matrix™, and RPR®
- U.S.-based customer support team


##### Keep everyone informed

- Notify clients when lockboxes are opened/closed
- Activate emergency alerts when necessary
...
- [SentriLock® Support](https://support.onekeymls.com/hc/en-us/articles/27445062574740-SentriLock-Resources)
- [Explore t](https://lockbox.onekeymls.com/) he Lockbox Store
