# 
    ...
    OneKey® MLS Launches RentSpree Integration for All Subscribers
  
  

Source: https://corporate.onekeymls.com/onekey-mls-successfully-launches-rentspree-integration-for-all-subscribers
...
# OneKey® MLS Successfully Launches RentSpree Integration for All Subscribers

Tricia Chirco • September 23, 2023

### Subscribers Gain Access to ApplyLink™, Saving Time and Money on Every Rental Transaction

![RentSpree Credit Report](https://lirp.cdn-website.com/78412f62/dms3rep/multi/opt/RentSpree-Tenant-Credit-Report-1920w.webp)

OneKey® MLS, the largest Multiple Listing Service in New York, has launched an integration with[RentSpree’s](https://corporate.onekeymls.com/products/rentspree)platform to streamline rental transactions. Now, all OneKey MLS subscribers will have access to RentSpree’s ApplyLink™ for new and existing rental listings, cutting down transaction time, limiting liability, increasing efficiency, and keeping the agent central to the rental transaction.
