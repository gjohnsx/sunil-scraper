...
Source: https://corporate.onekeymls.com/products/listtrac
...
![ListTrac](https://lirp.cdn-website.com/78412f62/dms3rep/multi/opt/listtrac-logo-1920w.png)

### The best listings are the most visible listings. With ListTrac, you can show sellers how many views their home received on major real estate sites, including your own

PREMIUM PRODUCT

TO ADD LISTTRAC TO YOUR ONEKEY® MLS SUBSCRIPTION, VISIT [LISTTRAC.COM](https://onekey.listtrac.com/admin/Plans)

[ListTrac Support](https://support.onekeymls.com/hc/en-us/articles/27252551530516-ListTrac-Resources)

## Premium: Online analytics for any listing.

#### Wide coverage

ListTrac allows agents to generate branded reports that show how many views their listings get on major consumer-facing sites including Zillow, Trulia, Homes.com and Realtor.com, as well as major franchise sites, local brokerage sites, and OneKeyMLS.com. If your broker syndicates your listing, ListTrac can track it and even show you where prospective buyers are located.

#### Interactive reporting

Send a beautifully branded interactive report every week to enable your clients to compare their home’s online performance against comparable listings. They can even investigate whether the number of buyers is trending up or down and where they are located. The report also includes the number of online inquiries their home has received.

#### Actionable information

Use the data from ListTrac to improve the quality of your listing. Not getting enough shares? Need more traction on a specific site? Need to know whether a price reduction had the desired effect? ListTrac has the data to inform your marketing strategies so you can invest wisely and keep your client informed.

#### Important metrics

ListTrac reports on the metrics most important to sellers: the number of views a listing has received across major real estate sites, within OneKey® MLS, and on individual sites; where those views originated by city; the number leads a home has received; the number of times a home has been favorited by consumers; and the number of times it has been shared.

ListTrac Analytics Platform - YouTube

[Photo image of ListTrac](https://www.youtube.com/channel/UC2NwjhGCSpDOy3Dw_DO5AMw?embeds_referring_euri=https%3A%2F%2Fcorporate.onekeymls.com%2F)

ListTrac

48 subscribers

[ListTrac Analytics Platform](https://www.youtube.com/watch?v=Nv2d5Z9_YrM)
...
- Configurable presentation to enhance existing brokerage brand
- Customizable seller reports with agent headshot, contact information


##### Automatic reports

- Automatic weekly activity reports for sellers
- Customizable layouts available


##### Useful metrics

- Compare sites and listings by views, shares, leads, and number of buyers
- Top performing sites and top listings by views, shares, leads, and number of buyers
